...
<template>
  <main class="membership-page">
    ...
    <section v-else-if="!membership" class="membership-layout">
      ...
      <div class="benefits"><h3>What membership is for</h3><article><Library :size="22" /><div><strong>Physical borrowing</strong><p>Reserve physical editions, borrow available copies, and track due dates.</p></div></article><article><BookOpen :size="22" /><div><strong>Member digital access</strong><p>Qualify for editions marked for active Litera members.</p></div></article><article><Check :size="22" /><div><strong>Future learning tools</strong><p>Membership will support upcoming reading and learning experiences.</p></div></article></div>
    </section>
