...
import { ArrowDown, ArrowLeft, ArrowUp, Check, ChevronRight, Eye, FileText, LoaderCircle, Pencil, Plus, RefreshCw, Trash2, X } from "@lucide/vue";
...
@media (max-width: 760px) { .admin-learning { padding: 70px 22px; }.admin-learning > header { display: block; }.admin-learning > header button { margin-top: 22px; }.learning-workspace { grid-template-columns: 1fr; }.learning-workspace aside { border-right: 0; border-bottom: 1px solid #ccd2cd; }.quiz-list { padding-left: 0; }.summary-admin { grid-template-columns: 1fr; }.editor-backdrop { padding: 12px; }.quiz-editor { padding: 22px; }.editor-meta { grid-template-columns: 1fr; }.option-editor > label { grid-template-columns: 18px 22px 1fr 28px; } }
</style>
